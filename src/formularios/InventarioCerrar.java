...
import inventario.GeneraValuado;
import inventario.UltimaRem;
...
import reporteConteos.TeoricovsFisicoCantidades;
...
PRINCIPAL_C5.isSelected() || SMO_J1_PT.isSelected() || SMO_MATERIA.isSelected() || ETIQUETAS.isSelected()){
				...
				GeneraValuado.main(almacenes, repositorio);
				DiferenciasValuado.main(almacenes, repositorio);
				ConteoTeorico.main(almacenes, repositorio);
				ConteosExcel.main(almacenes, repositorio);
				ConteoFinal.main(almacenes, repositorio);				
				diferenciasC.main(almacenes, repositorio);
				UltimaRem.main(almacenes, repositorio);
				FisicovsTeorico.main(almacenes, repositorio);
				TeoricovsFisicoCantidades.main(almacenes, repositorio);
